...
// --- FİLTRE BUTONLARINI AYARLA ---
function setupFilterButtons() {
    // EJS dosyasındaki .filter-btn sınıfına sahip butonları bulur
    ...
    buttons.forEach(btn => {
        btn.addEventListener('click', (e) => {
            ...
            if (text === 'Bekleyenler') {
                currentFilter = 'beklemede';
            } else if (text === 'Atananlar') {
                currentFilter = 'atandi';
            } else {
                currentFilter = 'all';
            }
...
async function refreshPoolTable() {
    ...
    try {
        ...
        // --- FİLTRELEME MANTIĞI ---
        // Veriyi ekrana basmadan önce eliyoruz
        ...
        tickets.forEach(t => {
            ...
            // 4. İncele Butonu
            // JSON verisini güvenli bir şekilde fonksiyona gönderme
            ...
            if (t.durum !== 'cozuldu') {
                ...
                // İsim Yazdırma (Tamamlandı yerine İsim)
...
// GÜNCELLEME: Hem 'atandi' hem de 'beklemede' ise butonu göster
